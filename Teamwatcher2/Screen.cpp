...
HBITMAP Screen::GetScreenShot(void)
...
HBITMAP Screen::ResizeImage(HBITMAP hBitmap, int w, int h)
{
...
BOOL Screen::DrawBitmap(HDC hDC, INT x, INT y, INT width, INT height, HBITMAP hBitmap, DWORD dwROP)
...
HBITMAP Screen::HBITMAPFromPixels(const std::vector<uint8_t>& Pixels, int width, int height, int BitsPerPixel)
...
void Screen::HBITMAPToPixels(HBITMAP BitmapHandle, std::vector<uint8_t>& Pixels, int width, int height, int BitsPerPixel)
{
