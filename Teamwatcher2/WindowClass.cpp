...
WindowManager::WindowClass::WindowClass(HINSTANCE current_instance, const std::string& class_name, const Graphics::color_t& color, const window_callback_t& callback) : 
	m_window_class(),
	...
	m_class_name(class_name)
{
	...
	m_window_class.hIcon = LoadIconA(current_instance, MAKEINTRESOURCEA(IDI_TEAMWATCHER2));
...
WindowManager::WindowClass::~WindowClass()
{
